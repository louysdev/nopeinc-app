import 'package:nopeinc_app/src/models/order.dart';
import 'package:nopeinc_app/src/pages/restaurant/orders/list/restaurant_orders_list_controller.dart';
import 'package:nopeinc_app/src/utils/my_colors.dart';
import 'package:nopeinc_app/src/widgets/no_data_widget.dart';
      ...
      child: ListView(
        ...
        children: [
          ...
          ListTile(
            ...
            trailing: Icon(Icons.inbox_rounded),
          ),
          _con.user != null ?
