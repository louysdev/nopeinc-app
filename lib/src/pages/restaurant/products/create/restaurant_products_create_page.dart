import 'dart:io';
import 'package:nopeinc_app/src/models/category.dart';
import 'package:nopeinc_app/src/pages/restaurant/products/create/restaurant_products_create_controller.dart';
    ...
    return GestureDetector(
      ...
      : Card(
        ...
        child: Container(
          ...
          width: MediaQuery.of(context).size.width * 0.26,
          child: Image(
            image: AssetImage('assets/img/package_add.png'),
          ),
        ),
      ),
    );
